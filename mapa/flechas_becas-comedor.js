		...
		arrows.append("line")
		  .each(function(d) {
		  		var desigualdad = (d.properties.indice_desigualdad == null ) ? 0 : d.properties.indice_desigualdad;
					var value = lineSize(Math.abs(d.properties.perc_bec_comedor_priv));
		      ...
		      d3.select(this)
		        ...
		        .attr("x2", value)
		        .attr("y2", 25)
		        .attr("class", Math.abs(d.properties.perc_bec_comedor_pub - d.properties.perc_bec_comedor_priv))
